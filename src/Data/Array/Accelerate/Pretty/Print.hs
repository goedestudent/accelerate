...
prettyPreOpenAcc config ctx prettyAcc extractAcc aenv pacc =
  case pacc of
    ...
    Expand _ sz get a               -> ppN "expand"      .$ [ ppF sz, ppF get,  ppA a ]
    PermutingExpand _ sz get a f def 
                                    -> ppN "expand-then-permute" .$ [ ppN "expand" .$ [ ppF sz, ppF get, ppA a ], ppN "permute'" .$ [ ppF f, ppA def ] ]
